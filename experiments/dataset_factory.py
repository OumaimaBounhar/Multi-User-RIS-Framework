...
class DatasetMode(str, Enum):
    ...
    ------
        ...
        LOAD_GENERATED (str): Load an existing dataset from disk. Use this mode when Re-running training on the same data to avoid expensive dataset regeneration.

        IMPORT_SIONNA (str): Import dataset generated by sionna.
    """
    GENERATE = "Create a new internal dataset" 
    LOAD_GENERATED = "Load previously generated internal dataset"
    IMPORT_SIONNA = "Use external Sionna dataset source"

class DatasetFactory:
    """ This class handles experiments dataset using the store by : 

        . Loading dataset from disk when DatasetMode.LOAD_GENERATED,
    ...
    def get_dataset(
        ...
        """ Main function responsible for returning the dataset for the experiment based on the specified mode.
            ...
            Args:
                dataset_mode (DatasetMode): The mode to determine how to obtain the dataset (GENERATE or LOAD_GENERATED).
        ...
        """
        if dataset_mode == DatasetMode.LOAD_GENERATED:
